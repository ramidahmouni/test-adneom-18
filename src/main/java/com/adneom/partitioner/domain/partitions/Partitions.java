 ...
 * This domain class is a list of Partition Object who offer 
 * A constructor
 * , Getter 
 * , Initializer
 * , List adder (to add list in existing list Partition)
 * , Updater (to update the list of object by cleaning and adding the list parameter)
 * , and 
...
public class Partitions {
	 ...
	 * 
	 * @param partitionList list of Partition Object
	 */
	 ...
	 * 
	 * @param partitionList a list of Partition object List<Partition>
	 */
